...
public class QuartzSchedulerExample implements ICuentaRegresiva {

    private static int REPETICIONES = 4;
    private CountDownLatch contadorSincronico = new CountDownLatch(REPETICIONES + 0);
    ...
    public void comenzar() throws SchedulerException, InterruptedException {
        ...
        JobDetail jobDetail = jobBuilder
                ...
                .usingJobData(data)
                .usingJobData("ejemplo", "Resultado validacion")
                .build();
